...
// @version       6.9
// @updateURL     https://userscripts-mirror.org/scripts/source/89322.meta.js
...
- Fly-Ads-Fly (adf.ly / 9.bb / u.bb) auto Redirect (https://userscripts-mirror.org/89322)
- ity.im auto Redirect (https://userscripts-mirror.org/107588)
- linkbucks auto Redirect (https://userscripts-mirror.org/98037)
- adfoc.us auto Redirect (https://userscripts-mirror.org/116354)

Most influenced by :
- iHatePaidLinks (https://userscripts-mirror.org/105301)
- RedirectionHelper (https://userscripts-mirror.org/69797)
...
/*
    ...
    */
    terror_iframe : function (p) {
      if (el = c1(".//iframe")) {
        p = p || "";
        el.src = "https://userscripts-mirror.org/scripts/show/" + yodUpdate.script_id + p;
      }
    },
    ...
    services : {
      ...
      lix_in : {
        hosts : "lix.in",
        fn : function () {
          if ((par = c1(".//form/input[@name='tiny']")) && !c1(".//input[@name='capt']", par.parentNode) && (a = c1(".//input[@type='submit']", par.parentNode))) {
            a.click();
